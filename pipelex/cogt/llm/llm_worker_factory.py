    ...
    def make_llm_worker(
        ...
        match llm_engine.llm_platform:
            case LLMPlatform.OPENAI | LLMPlatform.AZURE_OPENAI | LLMPlatform.PERPLEXITY | LLMPlatform.XAI:
                ...
                from pipelex.plugin.openai.openai_llm_worker import OpenAILLMWorker
            ...
            case LLMPlatform.ANTHROPIC | LLMPlatform.BEDROCK_ANTHROPIC:
                ...
                from pipelex.plugin.anthropic.anthropic_llm_worker import AnthropicLLMWorker
            ...
            case LLMPlatform.MISTRAL:
                ...
                from pipelex.plugin.mistral.mistral_llm_worker import MistralLLMWorker
            ...
            case LLMPlatform.BEDROCK:
                ...
                from pipelex.plugin.bedrock.bedrock_llm_worker import BedrockLLMWorker
